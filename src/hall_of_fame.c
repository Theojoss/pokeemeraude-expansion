...
static void Task_Hof_DisplayPlayer(u8 taskId)
{
    ...
    gTasks[taskId].tPlayerSpriteID = CreateTrainerPicSprite(GetPlayerTrainerPicIdByOutfit(gSaveBlock2Ptr->currOutfitId, gSaveBlock2Ptr->playerGender), TRUE, 120, 72, 6, TAG_NONE);
