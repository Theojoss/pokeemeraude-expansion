...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Et hop!\nVous avez attrapé {B_DEF_NAME}!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p"),
    ...
    [STRINGID_CANTESCAPE2]                          = COMPOUND_STRING("Vous n'avez pas réussi à fuir!\p"),
    ...
    [STRINGID_ITEMSCANTBEUSEDNOW]                   = COMPOUND_STRING("Vous ne pouvez pas utiliser vos objets maintenant.{PAUSE 64}"),
