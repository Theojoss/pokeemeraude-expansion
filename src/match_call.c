...
{
    { .trainerId = TRAINER_KIRA_AND_DAN_1, .text = COMPOUND_STRING("RITA") },
    { .trainerId = TRAINER_AMY_AND_LIV_1,  .text = COMPOUND_STRING("EVE") },
    { .trainerId = TRAINER_JOHN_AND_JAY_1, .text = COMPOUND_STRING("JOHN") },
    { .trainerId = TRAINER_LILA_AND_ROY_1, .text = COMPOUND_STRING("SAM") },
    { .trainerId = TRAINER_GABBY_AND_TY_1, .text = COMPOUND_STRING("INES") },
