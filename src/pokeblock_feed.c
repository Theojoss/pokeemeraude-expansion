...
static const u8 sText_Var1AteTheVar2[] = _("{STR_VAR_1} a mangé\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
static const u8 sText_Var1HappilyAteVar2[] = _("{STR_VAR_1} a mangé\n{STR_VAR_2} joyeusement.{PAUSE_UNTIL_PRESS}");
static const u8 sText_Var1DisdainfullyAteVar2[] = _("{STR_VAR_1} a mangé\n{STR_VAR_2} à contrecœur.{PAUSE_UNTIL_PRESS}");
