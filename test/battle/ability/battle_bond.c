...
SINGLE_BATTLE_TEST("Battle Bond transforms opponent's Greninja - Singles")
{
    ...
    GIVEN {
        ...
        if (monsCountPlayer != 1) {
            ...
            MESSAGE("Amphinobi ennemi est complètement chargé grâce à son lien avec son Dresseur!\p");
            MESSAGE("Amphinobi ennemi s'est transformé en Amphinobi d'Aurore!\p");
        } else {
            NONE_OF {
                ABILITY_POPUP(opponent, ABILITY_BATTLE_BOND);
                MESSAGE("Amphinobi ennemi est complètement chargé grâce à son lien avec son Dresseur!\p");
