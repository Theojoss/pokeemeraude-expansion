...
DOUBLE_BATTLE_TEST("Pickpocket checks contact/effect per target for spread moves")
{
    GIVEN {
        ...
        MESSAGE("Farfuret ennemi vole Baie Mangou de Qulbutoké!");
    } THEN {
...
SINGLE_BATTLE_TEST("Pickpocket does not activate if the user faints")
{
    GIVEN {
        ...
        MESSAGE("Farfuret ennemi est K.O.!\p");
    } THEN {
...
SINGLE_BATTLE_TEST("Pickpocket cannot steal from Sticky Hold")
{
    GIVEN {
        ...
        MESSAGE("L'objet de Tadmorv ne peut pas être volé!");
    } THEN {
        EXPECT(opponent->item == ITEM_NONE);
        EXPECT(player->item == ITEM_MAGOST_BERRY);
    }
...
SINGLE_BATTLE_TEST("Pickpocket activates after Magician steals an item")
{
    GIVEN {
        ...
        MESSAGE("Goupelin vole Baie Mangou de Farfuret ennemi!");
        ABILITY_POPUP(opponent, ABILITY_PICKPOCKET);
        MESSAGE("Farfuret ennemi vole Baie Mangou de Goupelin!");
    } THEN {
        EXPECT(opponent->item == ITEM_MAGOST_BERRY);
        EXPECT(player->item == ITEM_NONE);
    }
...
SINGLE_BATTLE_TEST("Pickpocket activates after Sticky Barb transfers")
{
    GIVEN {
        ...
        MESSAGE("Piquants s'attache à Qulbutoké!");
        ABILITY_POPUP(opponent, ABILITY_PICKPOCKET);
        MESSAGE("Farfuret ennemi vole Piquants de Qulbutoké!");
    } THEN {
...
SINGLE_BATTLE_TEST("Pickpocket activates after Thief or Covet steals an item")
{
    ...
    GIVEN {
        ...
        MESSAGE("Qulbutoké vole Baie Mangou de Farfuret ennemi!");
        ABILITY_POPUP(opponent, ABILITY_PICKPOCKET);
        MESSAGE("Farfuret ennemi vole Baie Mangou de Qulbutoké!");
    } THEN {
        EXPECT(opponent->item == ITEM_MAGOST_BERRY);
...
SINGLE_BATTLE_TEST("Pickpocket activates after Focus Sash is consumed")
{
    GIVEN {
        ...
        MESSAGE("Farfuret ennemi tient bon grâce à Ceinture Force!");
        ABILITY_POPUP(opponent, ABILITY_PICKPOCKET);
        MESSAGE("Farfuret ennemi vole Baie Mangou de Qulbutoké!");
    } THEN {
        EXPECT(opponent->item == ITEM_MAGOST_BERRY);
...
SINGLE_BATTLE_TEST("Pickpocket steals Life Orb after it activates")
{
    GIVEN {
        ...
        MESSAGE("Qulbutoké est blessé par Orbe Vie!");
        ABILITY_POPUP(opponent, ABILITY_PICKPOCKET);
        MESSAGE("Farfuret ennemi vole Orbe Vie de Qulbutoké!");
    } THEN {
...
SINGLE_BATTLE_TEST("Pickpocket steals Shell Bell after it heals the user")
{
    GIVEN {
        ...
        HP_BAR(player);
        ABILITY_POPUP(opponent, ABILITY_PICKPOCKET);
        MESSAGE("Farfuret ennemi vole Grelot Coque de Qulbutoké!");
    } THEN {
...
SINGLE_BATTLE_TEST("Pickpocket does not prevent King's Rock or Razor Fang flinches")
{
    GIVEN {
        ...
        ABILITY_POPUP(opponent, ABILITY_PICKPOCKET);
        MESSAGE("Farfuret ennemi vole Roche Royale de Qulbutoké!");
        MESSAGE("Farfuret ennemi a la trouille! Il ne peut plus attaquer!");
    } THEN {
