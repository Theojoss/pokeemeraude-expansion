...
SINGLE_BATTLE_TEST("Volt Absorb heals 25% when hit by electric type moves")
{
    GIVEN {
        ...
        MESSAGE("Voltali récupère des PV!");
    }
}
...
SINGLE_BATTLE_TEST("Volt Absorb does not activate if protected")
{
    GIVEN {
        ...
        NONE_OF { ABILITY_POPUP(player, ABILITY_VOLT_ABSORB); HP_BAR(player); MESSAGE("Voltali récupère des PV!"); }
    }
}
...
SINGLE_BATTLE_TEST("Volt Absorb prevents Cell Battery from activating")
{
    GIVEN {
        ...
        NONE_OF {
            ...
            MESSAGE("Grâce à Cell Batterie, Attaque de Voltali augmente!");
        }
    }
}
