[DIFFICULTY_NORMAL] =
{
    [TRAINER_LEAF_TEST] =
    {
        ...
        [TRAINER_SLIDE_MEGA_EVOLUTION] = COMPOUND_STRING("Trainer A: This message plays after the enemy's Mega Evolution completes.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_RED_TEST] =
    {
        ...
        [TRAINER_SLIDE_MEGA_EVOLUTION] = COMPOUND_STRING("Trainer B: This message plays after the enemy's Mega Evolution completes.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_PARTNER(PARTNER_STEVEN_TEST)] =
    {
        ...
        [TRAINER_SLIDE_MEGA_EVOLUTION] = COMPOUND_STRING("Trainer Partner: This message plays after the enemy's Mega Evolution completes.{PAUSE_UNTIL_PRESS}"),
